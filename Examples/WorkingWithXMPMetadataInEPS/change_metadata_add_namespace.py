...
class ChangeMetadata_AddNamespace:
    @staticmethod
    def run():
        # ExStart:1
        ...
        try:
            ...
            xmp.register_namespace_uri("tmp", "http://www.some.org/schema/tmp#")
            
            # Add new string property in new namespace.
            xmp.add("tmp:newKey", XmpValue("NewValue"))
            
            # Save EPS file with changed XMP metadata
            
            # Create ouput stream
            with open(data_dir + "add_namespace_output.eps", "wb") as out_ps_stream:
                # Save EPS file
