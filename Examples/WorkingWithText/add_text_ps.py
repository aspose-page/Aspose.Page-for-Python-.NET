...
class AddTextPS:
    ...
    def run():
        ...
        with open(data_dir + "AddText_outPS.ps", "wb") as out_ps_stream:
            ...
            font = aspose.page.ExternalFontCache.fetch_dr_font("Times New Roman", font_size, aspose.pydrawing.FontStyle.BOLD)
            ...
            document.outline_text(str, font, 50, 350,
            ...
            document.fill_and_stroke_text(str, font, 50, 400, aspose.pydrawing.SolidBrush(aspose.pydrawing.Color.yellow), #   new SolidBrush(aspose.pydrawing.Color.BlueViolet),
             GraphicsFactory.create_pen_by_brush_and_width(aspose.pydrawing.SolidBrush(aspose.pydrawing.Color.blue_violet), 2))
            ############################################################################################################################
