...
class AddRadialGradient2PS:
    ...
    def run():
        ...
        with open(data_dir + "RadialGradient2_outPS.ps", "wb") as out_ps_stream:
            ...
            path.add_rectangle(bounds)
            
            #Create and fill color blend object
            colors = [ aspose.pydrawing.Color.green, aspose.pydrawing.Color.blue, aspose.pydrawing.Color.black,
            aspose.pydrawing.Color.yellow, aspose.pydrawing.Color.beige, aspose.pydrawing.Color.red ]
            positions = [ 0.0, 0.2, 0.3, 0.4, 0.9, 1.0 ]
