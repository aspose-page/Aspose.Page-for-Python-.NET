...
class AddRectanglePS:
    ...
    def run():
        ...
        with open(data_dir + "AddRectangle_outPS.ps", "wb") as out_ps_stream:
            ...
            path.add_rectangle(aspose.pydrawing.RectangleF(250, 100, 150, 100))
            #Set paint
            ...
            path = aspose.pydrawing.drawing2d.GraphicsPath()
            path.add_rectangle(aspose.pydrawing.RectangleF(250, 300, 150, 100))
            #Set stroke
